...
//        Crie uma lista e coloque as sete notas.
      ...
      //    List<Double> notas = Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6);// ** este tipo não permite adicionar ou retirar elementos
       //   notas.add(10d); // nao permitido erro java.util.AbstractList.add
       // notas.remove(0d);// java.util.Iterator.remove java.util.AbstractCollection.remove
        List<Double> notas = new ArrayList<>(Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6));
         notas.add(10d); // permitido
         notas.remove(0d);// permitido
        //  List<Double> notas = List.of(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6);
      //  notas.add(11110d); // nao permitido erro immutable collection outros metodos são permitidos
     //  notas.remove(0d);// nao permitido erro immutable collection outros metodos são permitidos
